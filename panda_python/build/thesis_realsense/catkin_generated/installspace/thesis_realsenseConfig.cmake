...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'thesis_realsense' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/palash/thesis/thesisROS/panda_python/install/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/palash/thesis/thesisROS/panda_python/install/lib;/home/palash/thesis/thesisROS/panda_python/devel/lib;/home/palash/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
